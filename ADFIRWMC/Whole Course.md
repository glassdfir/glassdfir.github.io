...
|SleuthKit|<ul><li>Written by Brian Carrier, author of File System Forensic Analysis</li><li>Open Source</li><li>Python Bindings</li><li>Succeeds when others fail.</li></ul>|

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI5NzMyMTgxMV19
-->