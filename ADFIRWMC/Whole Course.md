...
In this example, I use PsExec to create two instances of notepad.exe on my local machine. One is in user session and visable, the other is not.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3NTUxMzA3XX0=
-->