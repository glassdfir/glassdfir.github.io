...
PsExec allows you to perform administrative tasks on multiple workstations but you can only interact with one at a time. Here is an example :

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk3ODI1MzA2Nl19
-->