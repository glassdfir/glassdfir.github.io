...
To access the remote environment variables, I needed to use cmd to launch RawCopy which means I couldn't use the **-c** to copy it over in one foul swoop. By using ^%computername^%-$MFT
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NzQwNDA0MTVdfQ==
-->